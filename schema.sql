...
-- What do i need to do? 
    -- I need to create a test file to ensure the tables are being populated, in that file, I will include print statements to verify that the queries are working
